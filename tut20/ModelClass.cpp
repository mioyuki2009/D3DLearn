...
bool ModelClass::Initialize(ID3D11Device* device, const CHAR* modelFilename, const CHAR* textureFilename1, const CHAR* textureFilename2)
{
	bool result;
...
bool ModelClass::LoadTexture(ID3D11Device* device, const CHAR* filename1, const CHAR* filename2)
{
	bool result;
