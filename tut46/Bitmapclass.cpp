...
bool BitmapClass::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, const char* textureFilename, const char* glowMapFilename, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool BitmapClass::LoadTextures(ID3D11Device* device,const char* filename, const char* glowMapFilename)
{
	bool result;
