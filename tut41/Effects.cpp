	...
	: Effect(device, filename)
{
	...
	LightViewMatrix2 = mFX->GetVariableByName("lightViewMatrix2")->AsMatrix();
	LightProjectionMatrix2 = mFX->GetVariableByName("lightProjectionMatrix2")->AsMatrix();
	DepthMapTexture2 = mFX->GetVariableByName("depthMapTexture2")->AsShaderResource();
	LightPosition2 = mFX->GetVariableByName("lightPosition2")->AsVector();
	DiffuseColor2 = mFX->GetVariableByName("diffuseColor2")->AsVector();
}
