...
public:
	...
	void SetShadowTexture(ID3D11ShaderResourceView* tex) { ShadowTexture->SetResource(tex); }
	...
	ID3DX11EffectTechnique* PassTech6;
	...
	ID3DX11EffectShaderResourceVariable* ShadowTexture;
};
