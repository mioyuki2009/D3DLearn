...
bool SoftShadowShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd)
{
	HRESULT result;
	...
	XMFLOAT3 lightPosition, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor)
{
	...
	Effects::BasicFX->SetShadowTexture(shadowTexture);
	...
	Effects::BasicFX->SetAmbientColor(vecDiffuseColor);
