	...
	: Effect(device, filename)
{
	...
	BumpMap = mFX->GetVariableByName("bumpTexture")->AsShaderResource();
	SpecMap = mFX->GetVariableByName("speTexture")->AsShaderResource();
	...
	SpecularPower = mFX->GetVariableByName("specularColor")->AsScalar();

	FogStart = mFX->GetVariableByName("fogStart")->AsScalar();
	FogEnd = mFX->GetVariableByName("fogEnd")->AsScalar();
}
