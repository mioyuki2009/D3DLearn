...
bool ParticleSystemClass::Initialize(ID3D11Device* device,const CHAR* textureFilename)
{
	bool result;
...
bool ParticleSystemClass::LoadTexture(ID3D11Device* device, const CHAR* filename)
{
	bool result;
