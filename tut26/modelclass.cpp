...
bool ModelClass::Initialize(ID3D11Device* device, const CHAR* modelFilename, const CHAR* texture1)
{
	bool result;
	...
	result = LoadTexture(device, texture1);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::LoadTexture(ID3D11Device* device, const CHAR* filename1)
{
	bool result;
