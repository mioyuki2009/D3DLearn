...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd)
{
	...
	Effects::BasicFX->PassTechTexture->GetPassByIndex(0)->GetDesc(&passDesc);
	...
	XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	...
	Effects::BasicFX->SetShaderTexture(texture);
	return true;
}
...
void TextureShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
	...
	Effects::BasicFX->PassTechTexture->GetPassByIndex(0)->Apply(0, deviceContext);
	// Render the triangle.
