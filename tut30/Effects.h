...
public:
	...
	void SetLightPosition(XMFLOAT4* v) { LightPosition->SetRawValue(v, 0, sizeof(XMFLOAT4) * 4); }
	void SetLightDiffuseColor(XMFLOAT4* v) { DiffuseColor->SetRawValue(v, 0, sizeof(XMFLOAT4) * 4); }
